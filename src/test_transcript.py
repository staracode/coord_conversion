...
class TestTranscript(unittest.TestCase):
    ...
    def test_coordinate(self):
        ...
        for i, transcript in enumerate(self.valid_transcripts):
            ...
            coord = transcript.get_genomic_coordinates_from_precomputed_intervals2(
                transcript_start[i]
            )
    ...
    def test_coordinate_tx_start_out_of_bounds(self):
        for i, transcript in enumerate(self.valid_transcripts):
            with self.assertRaises(ValueError):
                transcript.get_genomic_coordinates_from_precomputed_intervals2(100)
